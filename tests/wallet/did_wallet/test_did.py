...
from achi.wallet.did_wallet import did_wallet_puzzles
...
from achi.consensus.block_rewards import calculate_pool_reward, calculate_base_farmer_reward, calculate_timelord_reward
...
class TestDIDWallet:
    ...
    async def test_make_double_output(self, two_wallet_nodes):
        ...
        try:
            cost, result = puz.run_with_cost(DEFAULT_CONSTANTS.MAX_BLOCK_COST_ALVM, fullsol)
