...
from achi.full_node.generator import run_generator, create_generator_args
from achi.types.blockchain_format.program import Program, SerializedProgram, INFINITE_COST
from achi.types.generator_types import BlockGenerator, CompressorArg, GeneratorArg
...
TEST_GEN_DESERIALIZE = load_alvm("test_generator_deserialize.alvm", package_or_requirement="achi.wallet.puzzles")
DESERIALIZE_MOD = load_alvm("achilang_deserialisation.alvm", package_or_requirement="achi.wallet.puzzles")

DECOMPRESS_PUZZLE = load_alvm("decompress_puzzle.alvm", package_or_requirement="achi.wallet.puzzles")
DECOMPRESS_CSE = load_alvm("decompress_coin_solution_entry.alvm", package_or_requirement="achi.wallet.puzzles")

DECOMPRESS_CSE_WITH_PREFIX = load_alvm(
    "decompress_coin_solution_entry_with_prefix.alvm", package_or_requirement="achi.wallet.puzzles"
)
DECOMPRESS_BLOCK = load_alvm("block_program_zero.alvm", package_or_requirement="achi.wallet.puzzles")
TEST_MULTIPLE = load_alvm("test_multiple_generator_input_arguments.alvm", package_or_requirement="achi.wallet.puzzles")
