...
from alvm_tools.alvmc import compile_alvm_text

from achi.full_node.generator import run_generator
...
from achi.util.condition_tools import ConditionOpcode
...
COMPILED_GENERATOR_CODE = bytes(Program.to(compile_alvm_text(GENERATOR_CODE, [])))
...
class TestROM(TestCase):
    ...
    def test_get_name_puzzle_conditions(self):
        ...
        assert npc_result.alvm_cost == EXPECTED_COST
