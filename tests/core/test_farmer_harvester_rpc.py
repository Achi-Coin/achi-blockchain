...
class TestRpc:
    ...
    async def test1(self, simulation):
        ...
        try:
            ...
            await client.set_reward_targets(encode_puzzle_hash(new_ph, "ach"), encode_puzzle_hash(new_ph_2, "ach"))
            ...
            await client.set_reward_targets(None, encode_puzzle_hash(new_ph_3, "ach"))
            ...
            assert config["farmer"]["ach_target_address"] == encode_puzzle_hash(new_ph, "ach")
            assert config["pool"]["ach_target_address"] == encode_puzzle_hash(new_ph_3, "ach")

            new_ph_3_encoded = encode_puzzle_hash(new_ph_3, "ach")
