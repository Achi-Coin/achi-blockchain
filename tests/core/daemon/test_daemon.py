...
from achi.server.server import ssl_context_for_server
from achi.types.peer_info import PeerInfo
from achi.util.block_tools import BlockTools
from achi.util.ints import uint16
from achi.util.ws_message import create_payload
...
class TestDaemon:
    ...
    async def test_daemon_simulation(self, simulation, get_daemon):
        ...
        data = {}
        payload = create_payload("get_blockchain_state", data, service_name, "achi_full_node")
        await ws.send_str(payload)
