...
class TestBlockchainTransactions:
    ...
    async def test_validate_blockchain_spend_reorg_coin(self, two_nodes):
        ...
        coin_2 = None
        for coin in run_and_get_removals_and_additions(new_blocks[-1], test_constants.MAX_BLOCK_COST_ALVM)[1]:
    ...
    async def test_assert_fee_condition(self, two_nodes):
        ...
        # This condition requires fee to be 10 sten
        cvp_fee = ConditionWithArgs(ConditionOpcode.RESERVE_FEE, [int_to_bytes(10)])
        # This spend bundle has 9 sten as fee
