...
from achi.consensus.coinbase import create_farmer_coin
...
from achi.types.blockchain_format.foliage import TransactionsInfo
...
from achi.types.blockchain_format.slots import InfusedChallengeChainSubSlot
...
from achi.util.block_tools import BlockTools, get_vdf_info_and_proof
from achi.util.errors import Err
from achi.util.hash import std_hash
from achi.util.ints import uint8, uint64, uint32
...
class TestBodyValidation:
    ...
    @pytest.mark.asyncio
    async def test_alvm_must_not_fail(self, empty_blockchain):
        # 8
        pass
