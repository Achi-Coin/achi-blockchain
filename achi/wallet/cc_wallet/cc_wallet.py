...
from achi.consensus.cost_calculator import calculate_cost_of_program, NPCResult
from achi.full_node.bundle_tools import simple_solution_generator
from achi.full_node.mempool_check_conditions import get_name_puzzle_conditions
from achi.protocols.wallet_protocol import PuzzleSolutionResponse
...
from achi.util.condition_tools import conditions_dict_for_solution, pkm_pairs_for_conditions_dict
from achi.util.ints import uint8, uint32, uint64, uint128
from achi.util.json_util import dict_to_json_str
from achi.wallet.block_record import HeaderBlockRecord
from achi.wallet.cc_wallet.cc_info import CCInfo
from achi.wallet.cc_wallet.cc_utils import (
    CC_MOD,
    SpendableCC,
...
from achi.wallet.puzzles.genesis_by_coin_id_with_0 import (
    create_genesis_or_zero_coin_checker,
    genesis_coin_id_for_genesis_coin_checker,
    lineage_proof_for_genesis,
)
from achi.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import (
...
from achi.wallet.wallet_info import WalletInfo
...
class CCWallet:
    ...
    async def get_max_send_amount(self, records=None):
        ...
        if self.cost_of_single_tx is None:
            ...
            result: NPCResult = get_name_puzzle_conditions(
                program, self.wallet_state_manager.constants.MAX_BLOCK_COST_ALVM, True
            )
        ...
        max_cost = self.wallet_state_manager.constants.MAX_BLOCK_COST_ALVM / 2  # avoid full block TXs
        current_cost = 0
        total_amount = 0
        total_coin_count = 0
    ...
    async def get_sigs(self, innerpuz: Program, innersol: Program, coin_name: bytes32) -> List[G2Element]:
        ...
        error, conditions, cost = conditions_dict_for_solution(
            innerpuz, innersol, self.wallet_state_manager.constants.MAX_BLOCK_COST_ALVM
        )
