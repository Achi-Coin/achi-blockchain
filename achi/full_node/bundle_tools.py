...
from achi.full_node.generator import create_compressed_generator
from achi.types.blockchain_format.program import SerializedProgram, Program
...
def match_standard_transaction_at_any_index(generator_body: bytes) -> Optional[Tuple[int, int]]:
    ...
    # in case we later want to convert the template generator into a tree of ALVM
