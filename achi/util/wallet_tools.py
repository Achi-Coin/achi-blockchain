...
from achi.util.alvm import int_from_bytes, int_to_bytes
from achi.util.condition_tools import conditions_by_opcode, conditions_for_solution, pkm_pairs_for_conditions_dict
    ...
    def sign_transaction(self, coin_solutions: List[CoinSolution]) -> SpendBundle:
        ...
        for coin_solution in coin_solutions:  # type: ignore # noqa
            ...
            err, con, cost = conditions_for_solution(
                coin_solution.puzzle_reveal, coin_solution.solution, self.constants.MAX_BLOCK_COST_ALVM
            )
            if not con:
