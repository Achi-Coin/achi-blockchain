...
from achi.types.blockchain_format.foliage import Foliage, FoliageBlockData, FoliageTransactionBlock, TransactionsInfo
...
from achi.types.blockchain_format.reward_chain_block import RewardChainBlock, RewardChainBlockUnfinished
...
from achi.util.prev_transaction_block import get_prev_transaction_block
...
def create_foliage(
    ...
    if is_transaction_block:
        ...
        if block_generator is not None:
            ...
            result: NPCResult = get_name_puzzle_conditions(block_generator, constants.MAX_BLOCK_COST_ALVM, True)
