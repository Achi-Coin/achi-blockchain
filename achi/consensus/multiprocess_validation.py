...
from achi.consensus.block_header_validation import validate_finished_header_block
...
from achi.consensus.get_block_challenge import get_block_challenge
from achi.consensus.pot_iterations import calculate_iterations_quality, is_overflow_block
...
from achi.util.ints import uint16, uint64, uint32
from achi.util.streamable import Streamable, dataclass_from_dict, streamable
            ...
            try:
                ...
                if block.transactions_generator is not None and npc_result is None:
                    ...
                    npc_result = get_name_puzzle_conditions(
                        block_generator, min(constants.MAX_BLOCK_COST_ALVM, block.transactions_info.cost), True
                    )
                    removals, tx_additions = tx_removals_and_additions(npc_result.npc_list)
