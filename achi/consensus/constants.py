...
class ConsensusConstants:
    ...
    # Forks of achi should change this value to provide replay attack protection
    ...
    # Max coin amount uint(1 << 64). This allows coin amounts to fit in 64 bits. This is around 18M achi.
    MAX_COIN_AMOUNT: int
    # Max block cost in alvm cost units
    MAX_BLOCK_COST_ALVM: int
