...
from achi.consensus.block_body_validation import validate_block_body
from achi.consensus.block_header_validation import validate_finished_header_block, validate_unfinished_header_block
...
from achi.consensus.cost_calculator import NPCResult
...
from achi.types.blockchain_format.vdf import VDFInfo
...
from achi.types.generator_types import BlockGenerator, GeneratorArg
from achi.types.header_block import HeaderBlock
from achi.types.unfinished_block import UnfinishedBlock
from achi.types.unfinished_header_block import UnfinishedHeaderBlock
            ...
            if block.is_transaction_block():
                if block.transactions_generator is not None:
                    ...
                    npc_result = get_name_puzzle_conditions(
                        block_generator, min(self.constants.MAX_BLOCK_COST_ALVM, block.transactions_info.cost), False
                    )
        ...
        if block.is_transaction_block():
            if block.transactions_generator is not None:
                if npc_result is None:
                    ...
                    npc_result = get_name_puzzle_conditions(block_generator, self.constants.MAX_BLOCK_COST_ALVM, False)
                tx_removals, tx_additions = tx_removals_and_additions(npc_result.npc_list)
