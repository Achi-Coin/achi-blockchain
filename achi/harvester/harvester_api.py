...
from achi.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from achi.harvester.harvester import Harvester
from achi.plotting.plot_tools import PlotInfo, parse_plot_info
from achi.protocols import harvester_protocol
from achi.protocols.farmer_protocol import FarmingInfo
from achi.protocols.protocol_message_types import ProtocolMessageTypes
from achi.server.outbound_message import make_msg
...
from achi.util.api_decorators import api_request, peer_required
from achi.util.ints import uint8, uint32, uint64
from achi.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSAchiConnection
    ):
        """
