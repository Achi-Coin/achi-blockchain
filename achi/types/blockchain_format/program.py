...
from alvm import KEYWORD_FROM_ATOM, KEYWORD_TO_ATOM, SExp
from alvm import run_program as default_run_program
from alvm.casts import int_from_bytes
from alvm.EvalError import EvalError
from alvm.operators import OP_REWRITE, OPERATOR_LOOKUP
from alvm.serialize import sexp_from_stream, sexp_to_stream
from alvm_rs import STRICT_MODE, deserialize_and_run_program, serialized_length
...
class SerializedProgram:
    """
    An opaque representation of a alvm program. It has a more limited interface than a full SExp
    """
    ...
    def _run(self, max_cost: int, flags, *args) -> Tuple[int, Program]:
        ...
        # TODO: move this ugly magic into `alvm` "dialects"
