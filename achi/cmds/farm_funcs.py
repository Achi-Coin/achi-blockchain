...
from achi.util.misc import format_minutes
...
async def summary(rpc_port: int, wallet_rpc_port: int, harvester_rpc_port: int, farmer_rpc_port: int) -> None:
    ...
    if amounts is not None:
        print(f"Total achi farmed: {amounts['farmed_amount'] / units['achi']}")
        print(f"User transaction fees: {amounts['fee_amount'] / units['achi']}")
        print(f"Block rewards: {(amounts['farmer_reward_amount'] + amounts['pool_reward_amount']) / units['achi']}")
        print(f"Last height farmed: {amounts['last_height_farmed']}")
    else:
        print("Total achi farmed: Unknown")
    ...
    print("Note: log into your key using 'achi wallet show' to see rewards for each key")
