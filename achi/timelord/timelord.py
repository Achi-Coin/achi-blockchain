...
from achivdf import create_discriminant

from achi.consensus.constants import ConsensusConstants
from achi.consensus.pot_iterations import calculate_sp_iters, is_overflow_block
...
from achi.timelord.iters_from_block import iters_from_block
from achi.timelord.timelord_state import LastState
from achi.timelord.types import Chain, IterationType, StateType
from achi.types.blockchain_format.classgroup import ClassgroupElement
from achi.types.blockchain_format.reward_chain_block import RewardChainBlock
...
class Timelord:
    def __init__(self, root_path, config: Dict, constants: ConsensusConstants):
        ...
        self.server: Optional[AchiServer] = None
    ...
    def _can_infuse_unfinished_block(self, block: timelord_protocol.NewUnfinishedBlockTimelord) -> Optional[uint64]:
        ...
        timelord_reward_puzzle_hash: bytes32 = bytes.fromhex(self.config["reward_puzzle_hash"])
